...
import { createPosition } from "@/src/actions/client/position.actions";
...
export default function CreateContent() {
  ...
  const generalForm = useForm<CreatePositionInput>({
  ...
  const onSubmit = async (data: CreatePositionInput) => {
