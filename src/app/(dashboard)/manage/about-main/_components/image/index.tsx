...
import { updateMainAboutImage } from "@/src/actions/client/about-main.actions";

interface Props {
  existingData: IAbout | undefined;
  refetch: () => void;
}
export default function UpdateImage({ existingData, refetch }: Props) {
  ...
  const onSubmit = async (data: ImgInput) => {
    ...
    startTransition(async () => {
      try {
        const result = await updateMainAboutImage(existingData.documentId, {
