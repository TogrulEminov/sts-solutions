...
export default function MainPage() {
  ...
  return (
    <div>
      <WhiteBlockTitleArea
        title="İxtisaslaşdıqımız sahələr"
        link="/manage/expertise/create?locale=az"
      />
      <SearchingArea link="manage/expertise" />
      <Suspense
        fallback={
          <div
            style={{
      ...
      >
        <TableTypesArea<Enum>
          columns={columns}
          page="expertise"
          model={expertise_list}
          dataItems={(data?.data as unknown as Enum[]) || []}
          isError={isError}
          refetch={refetch}
          locale={locale}
          invalidateQueryKey={expertise_list}
          isLoading={isLoading}
        />
      </Suspense>
