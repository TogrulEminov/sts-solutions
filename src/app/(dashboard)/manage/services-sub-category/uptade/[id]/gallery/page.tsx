...
import { getServicesSubCategoryById, uptadeServicesSubCategoryImages } from "@/src/actions/client/services-sub.actions";
...
export default function GalleryUpdateImagePage() {
  ...
  const { data: existingData, refetch } =
    useServerQueryById<ServicesSubCategoryItem>(
  ...
  const onSubmit = async (data: GalleryInput) => {
    ...
    startTransition(async () => {
      try {
        const result = await uptadeServicesSubCategoryImages(
