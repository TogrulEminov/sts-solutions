...
import { createSlider } from "@/src/actions/client/slider.actions";
...
export default function CreateSlider() {
  ...
  const sliderForm = useForm<CreateSliderInput>({
    mode: "onChange",
  ...
  const onSubmit = async (data: CreateSliderInput) => {
            ...
            <FieldBlock title="Əsas şəkili daxil et">
              <SingleUploadImage
                ...
                setFile={(file) => {
                  ...
                  sliderForm.setValue("imageId", fileId, {
                    shouldValidate: true,
                  });
                }}
                file={uploadedFile}
