      ...
      <div className="container">
        <div className="grid lg:grid-cols-12 items-center gap-5">
          <article className="flex flex-col space-y-2 lg:col-span-7">
            <h2 className="font-inter lg:text-2xl text-white font-medium">Həllərimiz</h2>
          ...
          <CustomImage
            ...
            height={283}
            title=""
            src={"https://res.cloudinary.com/da403zlyf/image/upload/v1766332215/068b0ad823abd6d13ea028a7c184bda060f72f3d_fwver7.png"}
