    ...
    <section className="py-20 bg-ui-2   overflow-hidden rounded-tl-[50px] rounded-br-[50px]">
      <div className="container flex flex-col  space-y-10">
        <div className="flex items-center justify-between">
          <strong className="max-w-sm font-manrope font-extrabold lg:text-[46px] lg:leading-[54px] text-white">
            Xidmət təkliflərimiz
          </strong>
          <p className="font-manrope font-normal lg:max-w-lg text-base text-right text-white">
