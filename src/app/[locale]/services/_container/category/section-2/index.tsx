    ...
    <section className="py-10 lg:py-25">
      <div className="container mb-10 lg:mb-20">
        <div className="flex flex-col space-y-5">
          <h2 className="font-inter text-2xl lg:text-[40px] lg:leading-12 text-ui-7 font-bold">
            Ağıllı sistemlər, etibarlı enerji və davamlı texniki həllər
          </h2>
          <article className="font-inter font-normal text-base text-justify lg:text-start lg:text-[28px] lg:leading-9 text-ui-7">
