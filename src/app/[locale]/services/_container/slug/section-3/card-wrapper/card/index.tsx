...
export default function ServicesProduct({ index }: Props) {
  return (
    ...
    >
      <MotionStrong
        className="flex items-center gap-2 font-inter text-ui-7 font-bold lg:text-[28px] lg:leading-9"
        variants={{
      ...
      >
        <span className="w-13.5 h-13.5 rounded-full bg-ui-2 font-inter font-extrabold text-white flex items-center justify-center">
          {index}
        </span>
      ...
      <MotionParagraph
        className="font-inter lg:text-2xl text-ui-7 font-normal"
        variants={{
