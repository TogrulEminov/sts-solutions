...
interface CustomUiSelectsProps
...
const CustomUiSelect = forwardRef<HTMLSelectElement, CustomUiSelectsProps>(
...
CustomUiSelect.displayName = "CustomUiSelect";

export default CustomUiSelect;
