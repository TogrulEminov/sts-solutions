...
export default function ApplyBtn() {
  return (
    <button
      ...
      className="cursor-pointer group relative flex items-center gap-2 justify-center py-2 px-5 rounded-4xl bg-ui-1 text-white font-manrope text-sm font-normal overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-white/50"
    >
